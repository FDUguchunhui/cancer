...
# rawdata5
##bug (not fixed)
## a constant needed be changed when use new data!
...
# crosstable(rawdata4, cols = 'death')
...
save(main_data, file = 'data/main_data.RData')
```
